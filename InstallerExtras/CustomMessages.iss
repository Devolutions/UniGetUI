...
Armenian.InvalidInstallPath=Ընտրված տեղադրման վայրում կա անվավեր նշան։ Տեղադրման վայրը չի կարող պարունակել հատուկ նշաններ։ Շարունակելու համար մուտքագրեք վավեր ուղի, օրինակ՝ %1
Armenian.RemovingOldIcons=Հին պատկերակների հեռացում...
...
BrazilianPortuguese.InvalidInstallPath=Há um caractere inválido no local de instalação selecionado. O local de instalação não pode conter caracteres especiais. Insira um caminho válido para continuar, como %1
BrazilianPortuguese.RemovingOldIcons=Removendo ícones antigos...
...
Catalan.InvalidInstallPath=Hi ha un caràcter no vàlid a la ubicació d'instal·lació seleccionada. La ubicació d'instal·lació no pot contenir caràcters especials. Introduïu un camí vàlid per continuar, com ara %1
Catalan.RemovingOldIcons=S'estan eliminant les icones antigues...
...
Corsican.InvalidInstallPath=Ci hè un caratteru micca validu in u locu d'installazione selezziunatu. U locu d'installazione ùn pò micca cuntene caratteri speciali. Inserite un percorsu validu per cuntinuà, cum'è %1
Corsican.RemovingOldIcons=Rimozione di l'icone vechje...
...
Czech.InvalidInstallPath=Ve vybraném umístění instalace je neplatný znak. Umístění instalace nesmí obsahovat speciální znaky. Chcete-li pokračovat, zadejte platnou cestu, například %1
Czech.RemovingOldIcons=Odebírání starých ikon...
...
Danish.InvalidInstallPath=Der er et ugyldigt tegn i den valgte installationsplacering. Installationsplaceringen må ikke indeholde specialtegn. Indtast en gyldig sti for at fortsætte, f.eks. %1
Danish.RemovingOldIcons=Fjerner gamle ikoner...
...
Dutch.InvalidInstallPath=Er staat een ongeldig teken in de geselecteerde installatielocatie. De installatielocatie mag geen speciale tekens bevatten. Voer een geldig pad in om door te gaan, zoals %1
Dutch.RemovingOldIcons=Oude pictogrammen verwijderen...
...
Finnish.InvalidInstallPath=Valitussa asennussijainnissa on virheellinen merkki. Asennussijainti ei voi sisältää erikoismerkkejä. Anna kelvollinen polku jatkaaksesi, esimerkiksi %1
Finnish.RemovingOldIcons=Poistetaan vanhoja kuvakkeita...
...
French.InvalidInstallPath=L'emplacement d'installation sélectionné contient un caractère non valide. L'emplacement d'installation ne peut pas contenir de caractères spéciaux. Veuillez saisir un chemin valide pour continuer, par exemple %1
French.RemovingOldIcons=Suppression des anciennes icônes...
...
German.InvalidInstallPath=Der ausgewählte Installationsort enthält ein ungültiges Zeichen. Der Installationsort darf keine Sonderzeichen enthalten. Bitte geben Sie einen gültigen Pfad ein, um fortzufahren, z. B. %1
German.RemovingOldIcons=Alte Symbole werden entfernt...
...
Hebrew.InvalidInstallPath=יש תו לא חוקי במיקום ההתקנה שנבחר. מיקום ההתקנה אינו יכול להכיל תווים מיוחדים. אנא הזן נתיב חוקי כדי להמשיך, כגון %1
Hebrew.RemovingOldIcons=מסיר סמלים ישנים...
...
Japanese.InvalidInstallPath=選択したインストール場所に無効な文字が含まれています。インストール場所に特殊文字を含めることはできません。続行するには、%1 のような有効なパスを入力してください
Japanese.RemovingOldIcons=古いアイコンを削除しています...
...
Korean.InvalidInstallPath=선택한 설치 위치에 잘못된 문자가 있습니다. 설치 위치에는 특수 문자를 포함할 수 없습니다. 계속하려면 %1과 같은 올바른 경로를 입력하세요
Korean.RemovingOldIcons=이전 아이콘을 제거하는 중...
...
Norwegian.InvalidInstallPath=Det er et ugyldig tegn i den valgte installasjonsplasseringen. Installasjonsplasseringen kan ikke inneholde spesialtegn. Skriv inn en gyldig bane for å fortsette, for eksempel %1
Norwegian.RemovingOldIcons=Fjerner gamle ikoner...
...
Polish.InvalidInstallPath=W wybranej lokalizacji instalacji znajduje się nieprawidłowy znak. Lokalizacja instalacji nie może zawierać znaków specjalnych. Wprowadź prawidłową ścieżkę, aby kontynuować, na przykład %1
Polish.RemovingOldIcons=Usuwanie starych ikon...
...
Portuguese.InvalidInstallPath=Existe um caráter inválido no local de instalação selecionado. O local de instalação não pode conter caracteres especiais. Introduza um caminho válido para continuar, como %1
Portuguese.RemovingOldIcons=A remover ícones antigos...
...
Russian.InvalidInstallPath=В выбранном месте установки содержится недопустимый символ. Путь установки не может содержать специальные символы. Введите допустимый путь, чтобы продолжить, например %1
Russian.RemovingOldIcons=Удаление старых значков...
...
Slovenian.InvalidInstallPath=Na izbrani lokaciji namestitve je neveljaven znak. Lokacija namestitve ne sme vsebovati posebnih znakov. Vnesite veljavno pot za nadaljevanje, na primer %1
Slovenian.RemovingOldIcons=Odstranjevanje starih ikon...
...
Spanish.InvalidInstallPath=Hay un carácter no válido en la ubicación de instalación seleccionada. La ubicación de instalación no puede contener caracteres especiales. Introduzca una ruta válida para continuar, como %1
Spanish.RemovingOldIcons=Eliminando iconos antiguos...
...
Turkish.InvalidInstallPath=Seçilen yükleme konumunda geçersiz bir karakter var. Yükleme konumu özel karakterler içeremez. Devam etmek için geçerli bir yol girin, örneğin %1
Turkish.RemovingOldIcons=Eski simgeler kaldırılıyor...
...
Ukrainian.InvalidInstallPath=У вибраному місці встановлення міститься неприпустимий символ. Шлях встановлення не може містити спеціальні символи. Введіть допустимий шлях, щоб продовжити, наприклад %1
Ukrainian.RemovingOldIcons=Видалення старих значків...
