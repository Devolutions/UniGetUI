...
public static class PolicyEditorHelp
{
    ...
    public static string Sources => T("Restrict a package identifier to approved source names configured in one selected package manager. Enter exact configured names—not display names or URLs—and use a separate rule for each manager.");
